package com.reservation.landon.web.application;
...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception{
        ...
        mockRoomReservation.setRoomId(200);
        mockRoomReservation.setRoomNumber("Ju1");
        mockRoomReservation.setRoomName("JunitRoom");
